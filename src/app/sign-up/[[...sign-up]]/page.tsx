        ...
        <SignUp
          appearance={{
            ...
            elements: {
              ...
              formFieldLabel: "!text-zinc-650 dark:!text-zinc-350 font-mono text-[10px] uppercase font-bold",
              ...
              footerActionText: "!text-zinc-500 dark:!text-zinc-405 font-medium text-xs",
